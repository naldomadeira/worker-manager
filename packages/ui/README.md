# <img alt="Worker Manager" src="https://raw.githubusercontent.com/naldomadeira/worker-manager/main/packages/ui/src/static/images/logo.svg" width="35px" /> @worker-manager/ui 

UI packages of `bull-board`.

<p align="center">
  <a href="https://www.npmjs.com/package/@worker-manager/ui">
    <img alt="npm version" src="https://img.shields.io/npm/v/@worker-manager/ui">
  </a>
  <a href="https://www.npmjs.com/package/@worker-manager/ui">
    <img alt="npm downloads" src="https://img.shields.io/npm/dw/@worker-manager/ui">
  </a>
