...
// jsdom has no pointer capture or scrollIntoView, both of which Radix Select calls while it
// opens and highlights an option; without them the popup never appears under test.
