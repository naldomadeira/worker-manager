import { scanTargets, type MetricsClient } from './connection';
import type {
  HistoryStats,
  HistoryQueueStats,
  HistoryTier,
...
import { DAY_PATTERN, GLOBAL_QUEUE, HOUR_TIER, toDay, type MetricsKeys } from './keys';
 ...
 */
export class RedisHistoryAdmin implements HistoryAdministration {
